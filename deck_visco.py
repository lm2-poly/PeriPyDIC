...
class PD_deck():
    ...
    def __init__(self):
        with open("deck_visco.xml") as deck:
            try:
    ...
    def get_viscoelastic_material_properties(self):
        ...
        Relaxation_Time = []
        Relaxation_Time.append(
            float(self.initial_data['Material']['Relaxation_Time0']))
        Relaxation_Time.append(
            float(self.initial_data['Material']['Relaxation_Time1']))
        Relaxation_Time.append(
            float(self.initial_data['Material']['Relaxation_Time2']))
